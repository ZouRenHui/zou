...
> **PDF 工具箱 — 怎么用**
>
> **第一次：** 双击 `PdfToWord-Kylin-aarch64.run`，等弹出「安装完成」。
>
> **平时打开：** 双击桌面上的 **「PDF 工具箱」**。
>
> **打不开 / 没反应：** 双击 **「一键修复 PDF 工具箱」** 或 **「修复 PDF 工具箱」**，点确定，再双击 **「PDF 工具箱」**。
>
> 仍不行请联系安装人员，**不用输入任何命令**。
...
| 图标名称 | 什么时候点 |
|----------|------------|
| `PdfToWord-Kylin-aarch64.run` | 第一次安装 |
| `PDF 工具箱` | 日常使用 |
| `修复 PDF 工具箱` / `一键修复 PDF 工具箱` | 打不开时 |
| `打开 PDF 工具箱` | 已安装后直接打开 |

**远程修复：** 从 GitHub 下载 **`PdfToWord-修复包-aarch64.zip`**，解压到桌面，双击 **「一键修复 PDF 工具箱」**。
